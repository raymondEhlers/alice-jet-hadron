...
import os
import sys
sys.path.insert(0, os.path.abspath("../jet_hadron"))


# -- Project information -----------------------------------------------------

project = 'ALICE Jet-Hadron Correlations'
...
htmlhelp_basename = 'ALICEJetHadronCorrelationsdoc'
...
latex_documents = [
    (master_doc, 'ALICEJetHadronCorrelations.tex', 'ALICE Jet-Hadron Correlations Documentation',
     'Raymond Ehlers', 'manual'),
]
...
man_pages = [
    (master_doc, 'alicejet-hadroncorrelations', 'ALICE Jet-Hadron Correlations Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ALICEJetHadronCorrelations', 'ALICE Jet-Hadron Correlations Documentation',
     author, 'ALICEJetHadronCorrelations', 'ALICE Jet-hadron Correlations analysis.',
     'Miscellaneous'),
]
...
def setup(app):
    app.add_stylesheet("alice-jet-hadron.css")
